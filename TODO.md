...
> **この節は失効している。** vault `decision-20260721-knockon-minimal-release-q1` で **iOS 先行・Q1 内リリース**に方針転換した。以下の 2026-05-19 判断は履歴として残すが、現行方針は [docs/release/app-store-submission.md](docs/release/app-store-submission.md) が SoT。
>
