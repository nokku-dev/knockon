...
import { COLOR_FG_FAINT, COLOR_GROW, COLOR_LINE_BG } from './tokens';

// PR-Z2 (ADR-0024 §3b): 14D 達成率の折れ線グラフ。 SVG 自作 (chart library 不使用)。
// - X 軸: 14 日分 (左→右、 古い→新しい)
// - Y 軸: 達成率 (0.0 - 1.0)、 上端=100% 下端=0%
// - applicableNodes=0 の日は data point を打たない (= 線が途切れる)、 軸ラベルだけ残す
...
export const LineChart = ({
  ...
  return (
    <View style={[styles.root, { width, height }]} testID="line-chart">
